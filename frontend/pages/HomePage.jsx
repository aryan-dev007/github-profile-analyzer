      ...
      <div className="app-header">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              to="/compare"
              className="rounded-2xl border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-cyan-100 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
            >
              Compare
            </Link>
            <ThemeToggle />
      ...
      <section className="genz-hero mx-auto flex min-h-screen max-w-6xl items-center px-4 py-12">
        ...
        <div className="relative z-10 grid w-full gap-10 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="space-y-6">
            <div className="floating-pill inline-flex items-center gap-3 rounded-full border border-cyan-400/30 bg-white/5 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-cyan-100 shadow-sm">
              Live GitHub Signal Lab
              <span className="h-2 w-2 rounded-full bg-cyan-300" />
            </div>

            <h1 className="stagger-item text-4xl font-bold leading-tight text-white md:text-6xl">
              Turn developer footprints into a
              <span className="glow-title"> story of impact</span>.
            </h1>

            <p className="stagger-item max-w-xl text-base text-slate-200/80 md:text-lg">
            ...
            >
              ...
              <button
                type="submit"
                className="glow-button rounded-2xl px-6 py-4 text-base font-semibold text-slate-900"
              >
                Analyze Profile
              </button>
            </form>
            ...
            <div className="stagger-item flex flex-wrap gap-3 text-xs text-slate-300">
              <span className="soft-bounce rounded-full border border-slate-700/60 bg-white/5 px-3 py-1">
                No login required
              </span>
              <span className="rounded-full border border-slate-700/60 bg-white/5 px-3 py-1">
          ...
          <div className="relative">
            <div className="glass-card glass-strong neon-border relative flex min-h-[320px] flex-col justify-between overflow-hidden p-6 text-white">
            ...
            <div className="absolute -bottom-6 -left-6 hidden rounded-3xl bg-white/10 p-4 text-xs text-slate-200 shadow-lg backdrop-blur md:block">
